...
)
{
	...
	compute_potential(phi2, m2, potential_type, lambda_4, lambda_6,
		f_axion, sigma_soliton, kappa_kkls, &V_val, &dV_val, &d2V_val);
	...
	// Submatrix 2.
	jacobian_submatrix_2[0] = 16.0 * M_PI * dr2 * psi4 * (V_val - 2.0 * w2 * phi2 / alpha2);
	jacobian_submatrix_2[1] = 2.0 * dRu1;
	jacobian_submatrix_2[2] = 0.0;

	// Submatrix 3.
	jacobian_submatrix_3[0] = 8.0 * M_PI * dr2 * psi4 * (dV_val - 2.0 * w2 / alpha2) * phi;
	...
	// Submatrix 2.
	jacobian_submatrix_2[0] = 4.0 * M_PI * dr2 * psi4 * (V_val + w2 * phi2 / alpha2);
	jacobian_submatrix_2[1] = 2.0 * (dRu2 + 1.0 / ri);
	jacobian_submatrix_2[2] = 1.0;

	// Submatrix 3.
	jacobian_submatrix_3[0] = 2.0 * M_PI * dr2 * psi4 * (dV_val + w2 / alpha2) * phi;
	...
	// Submatrix 2.
	jacobian_submatrix_2[0] = 4.0 * dr2 * psi4 * (w2 / alpha2 - dV_val) * phi;
	jacobian_submatrix_2[1] = 2.0 * dRu3;
	jacobian_submatrix_2[2] = 0.0;

	// Submatrix 3.
	jacobian_submatrix_3[0] = dr2 * psi4 * (w2 / alpha2 - dV_val - 2.0 * phi2 * d2V_val);
